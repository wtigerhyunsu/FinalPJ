...
function orderStatusData(chainOrHQ) {
	$.ajax({
				...
				success : function(data) {
					...
					myTable += "<th>?щ즺 ?대쫫 </th><th>?щ즺 媛寃?/th><th>?щ즺 ?⑥쐞</th><th>?щ즺 臾닿쾶</th><th>?섎웾</th><th>二쇰Ц ?곹깭</th></tr></thead><tbody id = \"myTable\"><tbody></table></div>";
	...
	<div class="card-body">
		<div class="row">
			<div class="col-7 col-md-8"
				style="width: 100% !important; max-width: 100%; flex: 0 0 100% !important">
