	...
	function makeProgressBarAllChains(chainID_list, data) {
		...
		for (var c = 0; c < chainID_list.length; c++) {
			...
			for (var i = 0; i < conList.length; i++) {
				...
				result += '<div class="top_progressbar col-md-4" style ="display: inline-block">'
				result += "<div class='card'>"
				result += "<div class='card-body'>"
				...
				//result += '<div class="single-chart">';
				result += '<svg viewBox = "0 0 36 36" class = "circular-chart orange" xmlns="http://www.w3.org/2000/svg" width="150" height="150">';
				result += '<path class="circle-bg" d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831"></path>';
				result += '<path class="circle" stroke-dashArray ="';
				result += ((conList[i]['conCurrWeight'] / conList[i]['conFullWeight']) * 100).toFixed(2);
				result += ', 100" d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831"></path></svg>';
